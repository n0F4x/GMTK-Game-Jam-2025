...
export constexpr std::array player_back_with_weapon{
    Textures::Texture{ { 540, 0 }, { 46, 46 } },
    Textures::Texture{ { 586, 0 }, { 46, 46 } }
};

export constexpr std::array player_shoot{
    Textures::Texture{ { 632, 0 }, { 46, 46 } },
    Textures::Texture{ { 678, 0 }, { 46, 46 } }
};


export constexpr std::array player_move_gun{
    Textures::Texture{ { 724, 0 }, { 46, 46 } },
    Textures::Texture{ { 770, 0 }, { 46, 46 } }
};

export constexpr std::array player_move{ //
